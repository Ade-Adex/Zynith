...
export const MOCK_USER: UserType = {
  ...
  role: 'STUDENT',
  headline:
    'Full-stack Web Developer | Building the Digital World Through Code',
  ...
  enrollments: [
    {
      ...
      assignmentsSubmitted: ['m1_project'],
      peerReviewsCount: 2, // Needs 1 more to unlock Module 3

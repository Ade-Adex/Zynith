       ...
       {selectedCert && (
         ...
         >
           ...
           >
             ...
             {/* Main Content Block - Now sets flex-grow to evenly balance and insulate typography spacing */}
             <div className="flex-1 flex flex-col justify-center text-center relative z-10 my-auto py-4 md:py-0 space-y-4 md:space-y-6">
               <div>
             ...
             {/* Verified Footer Metadata - Locked perfectly to the baseline using mt-auto */}

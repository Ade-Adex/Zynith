        ...
        <div className="lg:col-span-8">
          {enrollment && courseDetails ? (
              ...
              <div className="mt-4">
                <Group justify="space-between" mb="xs">
                  ...
                  <Text size="xs" fw={800} c="dimmed">
                    {Math.round(
                      ((enrollment.progressPercentage || 0) / 100) * 20,
                    )}{' '}
                    / 20 LESSONS
                  </Text>
                </Group>
            ...
            <Card
              padding="xl"
              radius="16px"
              className="border border-dashed border-slate-200 bg-slate-50/50 flex flex-col items-center justify-center p-12 text-center min-h-[340px]"
            >
              <Text
                size="sm"
                fw={800}
                className="text-slate-700 uppercase tracking-wider mb-1"
              >

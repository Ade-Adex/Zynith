...
export function CourseEnrollCard({
  ...
  return (
    <div className="bg-white border border-slate-200 p-4 md:p-10 rounded-[3rem] shadow-[0_32px_64px_-16px_rgba(0,0,0,0.1)] relative overflow-hidden">
      <div className="absolute -top-24 -right-24 w-48 h-48 bg-blue-600/10 blur-[80px] rounded-full" />
      ...
      <div className="mb-10 relative z-10">
        ...
        <div className="flex items-baseline gap-3">
          ...
          {!isFree && (
            <span className="text-slate-300 font-bold line-through text-sm md:text-lg">
              ₦299
            </span>
          )}
        </div>
